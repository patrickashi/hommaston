             ...
             mobile:ml-0 xl:ml-[150px] lg:ml-[100px] md:ml-[100px] sm:ml-[100px]'>
                <div className='pt-2'>
                    <Link to="/Hommastonbluep">
                        <div className='2xl:text-3xl xl:text-3xl lg:text-3xl mobile:text-md text-center bg-white 2xl:rounded-xl mobile:rounded-lg 2xl:py-4 2xl:px-16 mx-auto text-[#292D32]
                ...
                <div className='pt-2'>
                    <Link to="/Hommastonredp">
                        <div className='2xl:text-3xl xl:text-3xl lg:text-3xl  mobile:text-md text-center bg-white 2xl:rounded-xl mobile:rounded-lg 2xl:py-4 2xl:px-16 text-[#292D32]
