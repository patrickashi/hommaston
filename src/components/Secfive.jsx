            ...
            <div className='flex py-16 2xl:flex-row xl:flex-row lg:flex-row md:flex-col sm:flex-col mobile:flex-col mobile:gap-[100px] sm:gap-[100px] md:gap-0 lg:gap-0 xl:gap-0 2xl:gap-5'>
                ...
                <div className='px-4 mobile:mx-4 py-4 2xl:w-[380px] mobile:w-[340px] flex flex-col items-center shadow-md rounded-md shadow-[#ED1C24] justify-center'>
                    <div className=' 2xl:w-[380px] mobile:w-[300px] flex justify-center'>
                        <img src={electricalfacilitydesign} className='h-25 w-cover justify-center rounded-md 2xl:w-[300px] mobile:w-[300px]' alt="img" />
                    </div>
                    <p className='py-2 text-center 2xl:w-[300px] mobile:w-[300px]'>Fundamentals of Electrical Engineering Facility Design</p>
                </div>

               <div className='px-4 py-4 mobile:mx-4 2xl:w-[380px] mobile:w-[340px] flex flex-col items-center shadow-md rounded-md shadow-[#ED1C24] mobile:justify-center'>
                    <div className=' 2xl:w-[380px] mobile:w-[300px] flex justify-center '>
                        <img src={instrumentationandcontrol} className='h-25 w-cover justify-center rounded-md 2xl:w-[300px] mobile:w-[300px]' alt="img" />
                    </div>
                ...
                <div className='px-4 py-4 mobile:mx-4 2xl:w-[380px] mobile:w-[340px] flex flex-col items-center shadow-md rounded-md shadow-[#ED1C24] justify-center'>
                    <div className=' 2xl:w-[380px] mobile:w-[300px] flex justify-center'>
                        <img src={mechanicalpiping} className='h-25 w-cover justify-center rounded-md 2xl:w-[300px] mobile:w-[300px]' alt="img" />
                    </div>
