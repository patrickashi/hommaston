  ...
  return (
    <div className='w-full py-8 font-Montserrat h-full bg-black text-white'>
        <div className=''>
            ...
            xl:mx-40 lg:mx-20 md:mx-20 sm:mx-4'>
                <div className='flex justify-between'>
                    <div className='flex '>Can I Pay For Course Online Using My Credit Card?</div>
            ...
            xl:mx-40 lg:mx-20 md:mx-20 sm:mx-4'>
                <div className='flex justify-between'>
                    <div className='flex '>Is Hommaston Limited On Social Media?</div>
            ...
            xl:mx-40 lg:mx-20 md:mx-20 sm:mx-4'>
                <div className='flex justify-between'>
                    <div className='flex '>What Payment Method Or Form Do You Accept?</div>
            ...
            xl:mx-40 lg:mx-20 md:mx-20 sm:mx-4'>
                <div className='flex justify-between'>
                    <div className='flex '>Are All Hommaston Courses Certified?</div>
            ...
            xl:mx-40 lg:mx-20 md:mx-20 sm:mx-4'>
                <div className='flex justify-between'>
                    <div className='flex '>Where Does the Training Take Place?</div>
            ...
            xl:mx-40 lg:mx-20 md:mx-20 sm:mx-4'>
                <div className='flex justify-between'>
                    <div className='flex '>What Is the Mode Of Training?</div>
            ...
            xl:mx-40 lg:mx-20 md:mx-20 sm:mx-4'>
                <div className='flex justify-between'>
                    <div className='flex '>How Do You Measure Attendee Satisfaction?</div>
