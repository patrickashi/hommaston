    ...
    <div className='font-Montserrat'>
        <div className='relative w-full h-[300px] bg-cover bg-center' style={{ backgroundImage: `url(${hepburnpic})` }}>
            ...
            2xl:mx-20 mobile:mx-5 rounded-[300px] shadow-md shadow-violet-400'>
                <h1 className='2xl:text-6xl xl:text-6xl lg:text-6xl mobile:text-3xl py-4 font-bold 2xl:text-white
                mobile:text-white bg-gray-900/50 w-full text-center rounded-full'>HepBurn</h1>
            </div>
        </div>
